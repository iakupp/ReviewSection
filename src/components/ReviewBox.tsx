...
const ReviewBox = ({ id, title, date, message }: ReviewBoxProps) => {
  return (
    <div
      key={id}
      id="review"
      className=" w-[337px] h-[207px] md:w-[550px] xl:w-[750px] mx-auto bg-(--review-box-bg) border-l-[5px] border-l-(--accent-color) pt-[2%] px-[20px] xl:px-[40px] xl:mr-[4.8em] xl:mt-[1.5em] shadow-[7px_5px_19px_-5px_rgba(0,0,0,0.5)]"
    >
